...
namespace CapaPresentacion
{
    public partial class FrmClientes : Form
    {
        ...
        private void FrmClientes_Load(object sender, EventArgs e)
        {
            ...
            {
                dgvdata.Rows.Add(new object[] {"",item.IdCliente,item.NumeroDocumento,item.NombreCompleto,item.Correo, item.Telefono,
        ...
        private void btnguardar_Click_1(object sender, EventArgs e)
        {
                ...
                if (obj.IdCliente == 0)
                {
                    ...
                    if (idgenerado != 0)
                    {
                        dgvdata.Rows.Add(new object[] {"",idgenerado,txtnumerodocumento.Text,txtnombrecompleto.Text,txtcorreo.Text,txttelefono.Text,
                ...
                else
                {
                    ...
                    if (resultado)
                    {
                        ...
                        row.Cells["NumeroDocumento"].Value = txtnumerodocumento.Text;
